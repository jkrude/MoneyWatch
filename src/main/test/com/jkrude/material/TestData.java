...
public class TestData {
  ...
  public static Camt getCamtWithTestData(){
    ...
    return new Camt(contractAccount,dateList,transferValidation,transferSpecification,usage,creditorId,mandateReference,customerReference,collectorReference,
